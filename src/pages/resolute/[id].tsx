...
const ResolutePage = () => {
  ...
  const detail = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit consequuntur molestiae ipsa, quaerat ad esse atque dolores odit sequi dolorum minus. Ipsam mollitia, voluptatibus iste delectus aliquid et perferendis animi? Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem esse repellat molestias modi animi consectetur, quos, porro quas ullam molestiae magnam ab? Fugiat veritatis nostrum sunt doloribus sequi dolores totam.";
          ...
          <div className="bg-neutral-focus mb-5 flex flex-col overflow-hidden rounded-xl shadow-2xl">
            <div className="hero bg-neutral">
              <div className="hero-content w-full flex-col p-0 md:flex-row md:px-5 md:py-10">
                <div className="bg-black h-[30rem] w-full overflow-hidden object-center md:w-[30rem] md:justify-items-center md:rounded-3xl md:align-middle md:drop-shadow-xl">
                  {/* {productData ? (
                  <Carousel
                ...
                <div className="w-full px-10 py-10 md:w-1/2 md:px-10 flex flex-col items-start">
                  ...
                  <h2 className="font-semibold text-4xl mt-3">Outcome : {"Choice a / Choice b"}</h2>
                  {/* <h3 className="font-normal text-xl text-gray-300 mt-3">summary detail</h3> */}
                  <h3 className="font-semibold text-lg mt-4 bg-base-100 px-3 py-2 rounded-xl">Ended: Dec 32</h3>
            ...
            <div className="mx-10 my-14 flex flex-col md:m-20">
              ...
              <h3 className="font-normal text-lg text-gray-300 mt-2">
                {showAbout ? detail : detail.slice(0,300)+" ...." }
              </h3>
              {
                detail.length>300 &&
                <div 
                  className="font-medium text-lg cursor-pointer mt-1" 
                  onClick={()=>{
              ...
              <div className="mt-8">
                ...
                <progress
                  className="flex-inline progress progress-success flex w-full bg-error mt-3"
